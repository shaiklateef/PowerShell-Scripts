...
# variables
#$pc = $env:computername
#$creds = get-credential <domain>\<account>

#send-netmessage "<message>" # sends message
Send-NetMessage "Cisco AMP Software is being Upgraded and will restart you computer in 5 minutes. Please save your work!!"
#start-sleep -s 300 # sleeps for x seconds
# restarts pc with credentials immediately
# alternatively you can add -confirm to require a confirmation
#restart-computer -computername $pc -credential $creds  -force